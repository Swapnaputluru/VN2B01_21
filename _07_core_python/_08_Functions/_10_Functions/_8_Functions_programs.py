...
it is defined (func() above) and trying to call local variable outside its scope(func()) will through an Error. However, 
we can call global variable anywhere in the program including functions (func()) defined in the program.
