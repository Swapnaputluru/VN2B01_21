...
print("it gives letter position in reverse order:", statement.rfind("r"))
print("it saperate the string:", "Welcome to vn2 solutions".split())
print("it will break the line:", "Good morning\nWelcome to the office".splitlines())
print("true or false return depends on start with given condition:", "good morning".startswith("G"))
print("convert each word first letter into capital:", "hi hello welcome".title())
